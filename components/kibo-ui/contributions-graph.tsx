...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      // Level and hover fills live in one CSS rule on the calendar container
      // (.contribution-blocks in globals.css) instead of as utility classes
      // here: repeating them on ~370 blocks added ~290KB to the served HTML.
      className={className}
